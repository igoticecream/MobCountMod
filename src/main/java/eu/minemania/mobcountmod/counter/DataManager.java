...
public class DataManager
{
    ...
    private final String[] passives = {"Chickens: ", "Pigs: ", "Sheep: ", "Cows: ", "Horses: ", "Rabbits: ", "Wolves: ", "Ocelots: ", "Parrots: ", "Bats: ", "Iron Golems: ", "Snow Golems: ", "Players: ", "Fishes: ", "Traders: ", "Dolphins: ", "Polarbears: ", "Squids: ", "Turtles: "};
    private final String[] hostiles = {"Zombies: ", "Blazes: ", "Endermans: ", "Spiders: ", "Creepers: ", "Witches: ", "Endermites: ", "Slimes: ", "Guardians: ", "Illagers: ", "Ghasts: ", "Phantoms: ", "Shulkers: ", "Silverfishes: ", "Skeletons: ", "Vexes: "};
    ...
    public void hostileLimit()
    {
        ...
        for (int i = 0; i < 16; i++)
        {
            totalCount += getCounter().countEntity(i + 19);
        }
        ...
        if (totalCount > 149)
        {
            if (this.playSoundCount == 0)
            {
                SoundEvent soundEvent = IRegistry.SOUND_EVENT.get(new ResourceLocation(Configs.Generic.SOUNDFILE.getStringValue()));
                if (soundEvent != null)
                {
                    ISound sound = SimpleSound.master(soundEvent, 1.0F);
            ...
            if (this.sendMsgCount == 0)
            {
                ...
                {
                    Minecraft.getInstance().player.sendChatMessage("/ch qm f Automated Message: "	+ totalCount + " mobz. Kill pl0x.");
                }
                if (Configs.Generic.MESSAGE_LIST.getStrings() != null && Configs.Generic.MESSAGE_LIST.getStrings().size() > 0)
                {
                    ...
                    {
                        Minecraft.getInstance().player.sendChatMessage("/m " + player	+ " Automated Message: " + totalCount + " mobz. Kill pl0x.");
                    }
                }
                this.sendMsgCount++;
            }
