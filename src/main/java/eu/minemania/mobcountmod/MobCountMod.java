...
public class MobCountMod implements InitializationListener
{
    ...
    public void onInitialization()
    {
        ...
        MixinBootstrap.init();
        Mixins.addConfiguration("mixins.mobcountmod.json");
        ...
        {
            throw new IllegalStateException("Malilib not found. Requires Malilib for MobCountMod", e);
        }
